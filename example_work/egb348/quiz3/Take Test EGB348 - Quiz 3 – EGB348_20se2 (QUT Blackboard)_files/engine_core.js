...
eesy.define(['jquery-private', 'context-probe', 'context-handling', 'monitor-handling',
    ...
    'utils', 'sessionInfo', 'session-events', 'json!settings-uef'], function ($, ctxProbe, ctxHandling, monitorHandling, eventsUrlChange, eventsDOMChange, eventsIframe, engineState, keepAlive, presentation, foundItemsHandler, mouse, contextTreeMatcher, eesyTimers, hints, helpitemHandling, supportTab, utils, sessionInfo, sessionEvents, settingsUef) {
    ...
    function hideExpertToolChromePlugin() {
        if (typeof chrome === "object" && typeof chrome.runtime === "object") {
            chrome.runtime.sendMessage(settingsUef.UEF.CHROME_EXTENSION_ID, { text: "hideExpertTool" }, { includeTlsChannelId: false }, function (response) {
                if (!response) {
